...
class StatusRequestPacket : ClientPacket {
    override val id = Packet.Serverbound.Status.PingStart
    ...
    companion object {
        fun init() = PacketRegistry.register(
            ...
            Packet.Serverbound.Status.PingStart,
            ::decode
        )

        fun decode(packet: Source) = StatusRequestPacket()
    }
